...
//
const BotName = 'BOT ./KanaoTsuyuri'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/_demon.08?igshid=mrfqxiom3xfb'; // Nama Instagramlu cok
const whatsapplu = '0895-3230-14190'; // Nomor whatsapplu cok
const kapanbotaktif = 'Panggil Aja'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/DK9RdvXDBfBIH0Qy9alAVo'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/DK9RdvXDBfBIH0Qy9alAVo'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@Kanao`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@Kanao`)
})
